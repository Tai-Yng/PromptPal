    ...
    <div class="settings-modal">
      ...
      <div class="settings-body">
        ...
        <div v-if="activeTab === 'pet'" class="settings-section">
          ...
          <div class="form-group">
            <label class="form-label">default_prompt:</label>
            <select
              :value="store.petConfig.defaultPromptId"
              class="form-select"
              @change="(e) => store.updatePetConfig({ defaultPromptId: (e.target as HTMLSelectElement).value })"
            >
              <option value="">-- 双击复制第一个提示词 --</option>
              <option
            ...
            <span class="form-hint">双击桌宠快速复制此提示词</span>
          </div>

          <div class="status-bar">
            <span class="status-indicator active"></span>
            <span class="status-text">
              Double-click pet to pause/resume
            </span>
          </div>
        </div>
